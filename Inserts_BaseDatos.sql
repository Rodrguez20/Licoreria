...
('Calixto Rodriguez','calixto@example.com','909090',1,'','','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3',1)
...
('Base de datos','fas fa-database',1),
...
--*menu hijos - Base de datos
insert into Menu(descripcion,idMenuPadre, controlador,paginaAccion,esActivo) values
('Respaldo',6,'Reporte','Backup',1),
('Restauracion',6,'Reporte','Restore',1)
